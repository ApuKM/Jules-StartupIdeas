                    ...
                    <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-2xl space-y-8 relative overflow-hidden">
                        ...
                        <div className="text-center space-y-2 relative">
                            <h2 className="text-3xl font-black text-slate-900 tracking-tight">
                                Join <span className="text-(--primary)">Jules</span>
                            </h2>
                            <p className="text-slate-500 font-medium">Create your account to start</p>
                        </div>
                        ...
                        >
                            ...
                            <Button
                                type="submit"
                                className="w-full h-14 text-lg font-semibold rounded-2xl shadow-xl shadow-blue-600/20 group bg-(--primary)"
                            >
